...
IF(MSVC)
	IF(CURL_STATIC)
		SET(CURLASIO_LIBRARY_NAME libcurl)
	ELSE()
		SET(CURLASIO_LIBRARY_NAME libcurl_imp)
	ENDIF()
ELSE()
	IF(CURL_STATIC)
		SET(CURLASIO_LIBRARY_NAME curl)
	ELSE()
		SET(CURLASIO_LIBRARY_NAME libcurl)
	ENDIF()
ENDIF()

FIND_LIBRARY(CURL_LIBRARY_DEBUG "${CURLASIO_LIBRARY_NAME}d" HINTS ${CURL_ROOT} PATH_SUFFIXES lib)
FIND_LIBRARY(CURL_LIBRARY_RELEASE "${CURLASIO_LIBRARY_NAME}" HINTS ${CURL_ROOT} PATH_SUFFIXES lib)
